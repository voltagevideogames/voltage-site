...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (submission.status !== 'counter_sent') {
      return jsonResponse(400, { error: 'This submission cannot be declined right now' });
    }
    ...
    if (updateError) {
      console.error('decline-customer-offer update error:', updateError);
      return jsonResponse(500, { error: 'Failed to decline offer' });
    }
    ...
    console.error('decline-customer-offer unexpected error:', error);
